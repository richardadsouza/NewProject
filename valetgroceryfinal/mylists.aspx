<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true"
    CodeBehind="mylists.aspx.cs" Inherits="groceryguys.mylists" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        Image5.src = "images/subtab5-h.png";
    ...
    <asp:UpdatePanel ID="updatePnl1" runat="server">
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="padding-left: 10px;">
                <tr>
                    <td align="left" class="formHeading">My Shopping Lists
                    </td>
                </tr>
                <tr>
                    <td height="10px"></td>
                ...
                <tr>
                    <td valign="top" align="left">
                        ...
                        <asp:Panel ID="pnlNoSaveList" runat="server">
                            <table>
                                <tr>
                                    <td class="ErrorTxt1">You currently do not have any saved shopping lists.
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    <td class="formTextUser">Creating your shopping list is easy. Start creating a list now.
                                    </td>
                                </tr>
                                <tr>
                                    <td class="formTextUser" style="padding-left: 10px; padding-top: 5px;">Create a shopping list that you can save to use week after week. Why fill up your
