    ...
    public partial class confirmaddress : System.Web.UI.Page
    {
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                insertAddressInfo = dbInfo.AddressInfo(txtAddress1.Text, txtAddress2.Text, txtCity.Text, Convert.ToString(drpState.SelectedValue), Convert.ToString(drpZip.SelectedValue), strSpecialInfo, Convert.ToInt32(Request.Cookies["userId"].Value));
