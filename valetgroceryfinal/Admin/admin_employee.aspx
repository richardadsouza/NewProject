<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true"
    CodeBehind="admin_employee.aspx.cs" ValidateRequest="false" Inherits="groceryguys.Admin.admin_employee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="Logoutlink">Employee Administration
            </td>
        </tr>
        <tr>
            <td>&nbsp;
                    ...
                    <tr>
                        <td width="100%">
                            <asp:UpdatePanel ID="update1" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gridmployeeList" runat="server" AutoGenerateColumns="False" Width="80%"
                                        AllowPaging="true" PageSize="10" OnPageIndexChanging="gridmployeeList_PageIndexChanging"
                                        OnRowCommand="gridmployeeList_OnRowCommand" CssClass="gridBorder" CellPadding="0"
                                        CellSpacing="0" AllowSorting="True" OnSorting="gridmployeeList_Sorting">
                                        <Columns>
