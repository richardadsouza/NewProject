    ...
    public partial class admin_UploadProductPrice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Check != "" && Check != null)
                {
                    ...
                    upcText.Text = Request.QueryString["strUPC"];
        ...
        protected void btnBegin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strUPC = upcText.Text;
                Response.Redirect("ViewProductdDetailsexport.aspx?loc=" + locationId + "&shefId=" + shefId + "&perPage=" + perPage + "&strKey=" + strKey + "&strUPC=" + strUPC, false);
