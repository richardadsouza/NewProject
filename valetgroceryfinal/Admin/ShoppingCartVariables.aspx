<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true"
    CodeBehind="ShoppingCartVariables.aspx.cs" ValidateRequest="false" Inherits="groceryguys.Admin.ShoppingCartVariables" %>
                            ...
                            <td height="30" class="formText">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td width="44%" align="right" class="formText">
                                            <span class="star">*</span>Delivery Fee for Members($):
                                        </td>
                                        <td width="56%" height="40">
                                            <asp:TextBox ID="txtMemberDeliveryFee" runat="server" CssClass="textBox" MaxLength="5"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtMemberDeliveryFee"
                                                ErrorMessage="Delivery fee is required" ForeColor="White" Text="*"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtMemberDeliveryFee"
                                                ValidationExpression="^(?=.*[0-9].*$)\d*(?:\.\d+)?$" ErrorMessage="Only number for delivery fee"
                                                Text="*" ForeColor="White"></asp:RegularExpressionValidator>
                                        </td>
                                    </tr>
                                   <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="56%" height="40">
                                            <asp:TextBox ID="txtDeliveryFeeCutOff" runat="server" CssClass="textBox" MaxLength="3"></asp:TextBox>
