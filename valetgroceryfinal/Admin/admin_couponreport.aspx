<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true"
    CodeBehind="admin_couponreport.aspx.cs" ValidateRequest="false" Inherits="groceryguys.Admin.admin_couponreport" %>
                ...
                <tr>
                    <td>
                        <fieldset>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td height="30" class="formText" nowrap="nowrap">Choose the dates below for which you would like to see all coupon details: 
                                    </td>
                                </tr>
                                <tr>
                                    <td height="3px">&nbsp;
