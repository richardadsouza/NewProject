<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="ViewClientActivityReport.aspx.cs" Inherits="groceryguys.ViewClientActivityReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">    
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left: 10px;">
        ...
        <tr>
            <td class="Logoutlink">All Users Details For Registered Between
                <asp:Label ID="lblStDate" runat="server" ForeColor="Red"></asp:Label>
                and 
               <asp:Label ID="lblEndDate" runat="server" ForeColor="Red"></asp:Label>
                for 
