<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PopupScript.ascx.cs" Inherits="groceryguys.Admin.PopupScript" %>
<script language="javascript" type="text/javascript">
     /***Saved List Report ****/
    function openUserSavedListDetailsPopUp(id) {
        dhtmlmodal.open('UserInfo', 'iframe', 'UserSavedListDetails.aspx?listId=' + id, '', 'width=710px,height=500px,center=1,resize=0,scrolling=0')
    }
    ...
    function openOrderDetailPopUp(ordId, userId) {
        dhtmlmodal.open('UserInfo', 'iframe', 'UserOrderdetailsInfo.aspx?orderId=' + ordId+ '&userId=' + userId, '', 'width=710px,height=490px,center=1,resize=0,scrolling=0')
    }
...
//Home page popup
    ...
    function openUserOrderDetailNewPopUp(ordId,userId) {
        dhtmlmodalNew.open('UserInfo', 'iframe', 'UserOrderdetailsInfo.aspx?orderId=' + ordId + '&userId=' + userId, '', 'width=710px,height=490px,center=1,resize=0,scrolling=0')
    }
