<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="premadelist.aspx.cs" Inherits="groceryguys.Admin.premadelist" %>
<%@ Register Src="~/Admin/cartadmin.ascx" TagName="UserScript" TagPrefix="uc1" %>
                        ...
                        <table>
                            <tr>
                                            ...
                                            <td width="435" valign="top">
                                                ...
                                                <asp:Panel ID="pnlAllProd" runat="server">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:GridView ID="gridProductList" runat="server" AutoGenerateColumns="False" Width="635px"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Add" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemStyle Height="45px" Width="35px" />
                                                                            <ItemTemplate>
                                ...
                                <td valign="top" align="left" style="padding-left: 2px;" width="20%">
                                    <uc1:UserScript ID="UserScript2" runat="server" />
                                </td>
                            </tr>
                        </table>
                    </td>
