<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="NewsPreview.aspx.cs" Inherits="groceryguys.Admin.NewsPreview1" %>
                        ...
                        <tr>
                            <td height="40">
                                <table width="80%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td align="center">
                                            <asp:Label ID="lblMsg" CssClass="formText" runat="server"></asp:Label></td>
                                    </tr>
                                                ...
                                                <tr>
                                                    <td class="MainTableBorder">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td height="2" class="underheaderbgblack"></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="headingbox">THIS WEEK SPECIALS
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="underheaderbgblack"></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="#f6f6f6">
                                                            ...
                                                            <tr>
                                                                <td class="headingbox">FEATURED PRODUCTS
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="underheaderbgblack"></td>
                                                            ...
                                                            <tr>
                                                                <td class="headingbox">We look forward to delivering to you!
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                        <tr>
                                                                            <td class="formTextSmall" align="center">If you would like to un-subscribe to this newsletter please contact us at
                                                                                 <%--<a href="#">customerservice@groceryu.com</a>  --%>
                                                                                <asp:Literal ID="litcustomerservice" runat="server"></asp:Literal>
                                                                                with UNSUBSCRIBE in the email subject. 
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                        ...
                                        <td style="padding-left: 10px;">
                                            ...
                                            <span style="padding-left: 200px;">
                                                <asp:ImageButton ID="imgBack1" runat="server" ImageUrl="../images/backbutton.jpg"
                                                    Width="71" Height="23" border="0" CausesValidation="false" OnClick="imgBack1_Click" /></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
