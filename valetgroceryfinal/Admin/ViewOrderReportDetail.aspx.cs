            ...
            if (dsOrderList.Tables.Count > 0)
            {
                if (dsOrderList != null && dsOrderList.Tables.Count > 0 && dsOrderList.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow dtrow in dsOrderList.Tables[0].Rows)
                    {
                        ...
                        dtrow["orders_tax2"] = Convert.ToString(Math.Round(Convert.ToDouble(dtrow["orders_tax2"]), 2));
                        taxtotal2 = taxtotal2 + Convert.ToDouble(dtrow["orders_tax2"]);
                        ...
                        transAmount = transAmount + Convert.ToDouble(dtrow["transactions_amount"]);
                    }
                    ...
                    lblTotTax2.Text = Convert.ToString("$" + Convert.ToDecimal(taxtotal2).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture));
                    ...
                    lblShoppingFund.Text = Convert.ToString("$" + Convert.ToDecimal(transAmount).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture));
