...
namespace groceryguys.Admin
{
    public partial class Newsletter : System.Web.UI.Page
    {
        ...
        public void BindGridProduct()
        {
            ...
            {
                string[] splitter = { "|" };
                prodInfo = tempSaleProduct.Split(splitter, StringSplitOptions.None);
            }
            ...
            // dsSalesItemList = dbListInfo.GetSalesDetails1(Convert.ToInt32(AppConstants.locationId));

            //dsSalesItemList = dbListInfo.GetSalesDetails_New(Convert.ToInt32(AppConstants.locationId),Convert.ToInt32(prodInfo[i]));
            ...
            for (int i = 0; i < prodInfo.Length; i++)
            {
                ...
                if (dsSalesItemList.Tables.Count > 0)
                {
                    if (dsSalesItemList != null && dsSalesItemList.Tables.Count > 0 && dsSalesItemList.Tables[0].Rows.Count > 0)
                    {
                        newProduct = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_id"]);
                        ...
                        else if (cntProduct == 1)
                        {
                            ...
                            if (i == 1)
                            {
                                ...
                                lblProductId2.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_id"]);
                                lblProdTitle2.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_title"]);
                                //lblProdPrice2.Text = "$" + Convert.ToString(Math.Round(Convert.ToDouble(dsSalesItemList.Tables[0].Rows[1]["productlink_price"]), 2));
                                lblProdPrice2.Text = "$" + Convert.ToDecimal(dsSalesItemList.Tables[0].Rows[0]["productlink_price"]).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture);
                                litProdView2.Text = "<a href='" + strView + "'class='sublink' target='_blank'>View</a>";
                            }
                        ...
                        else if (cntProduct == 2)
                        {
                            if (i == 2)
                            {
                                ...
                                lblProductId3.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_id"]);
                                lblProdTitle3.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_title"]);
                                // lblProdPrice3.Text = "$" + Convert.ToString(Math.Round(Convert.ToDouble(dsSalesItemList.Tables[0].Rows[2]["productlink_price"]), 2));
                                lblProdPrice3.Text = "$" + Convert.ToDecimal(dsSalesItemList.Tables[0].Rows[0]["productlink_price"]).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture);
                                litProdView3.Text = "<a href='" + strView + "'class='sublink' target='_blank'>View</a>";
                            }
                        ...
                        else if (cntProduct == 3)
                        {
                            ...
                            lblProductId4.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_id"]);
                            lblProdTitle4.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_title"]);
                            //lblProdPrice4.Text = "$" + Convert.ToString(Math.Round(Convert.ToDouble(dsSalesItemList.Tables[0].Rows[3]["productlink_price"]), 2));
                            lblProdPrice4.Text = "$" + Convert.ToDecimal(dsSalesItemList.Tables[0].Rows[0]["productlink_price"]).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture);
                            litProdView4.Text = "<a href='" + strView + "'class='sublink' target='_blank'>View</a>";
                        }
                        else if (cntProduct == 4)
                        {
                            ...
                            lblProductId5.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_id"]);
                            lblProdTitle5.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_title"]);
                            //lblProdPrice5.Text = "$" + Convert.ToString(Math.Round(Convert.ToDouble(dsSalesItemList.Tables[0].Rows[4]["productlink_price"]), 2));
                            lblProdPrice5.Text = "$" + Convert.ToDecimal(dsSalesItemList.Tables[0].Rows[0]["productlink_price"]).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture);
                            litProdView5.Text = "<a href='" + strView + "'class='sublink' target='_blank'>View</a>";
                        }
                        else if (cntProduct == 5)
                        {
                            ...
                            lblProductId6.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_id"]);
                            lblProdTitle6.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_title"]);
                            // lblProdPrice6.Text = "$" + Convert.ToString(Math.Round(Convert.ToDouble(dsSalesItemList.Tables[0].Rows[5]["productlink_price"]), 2));
                            lblProdPrice6.Text = "$" + Convert.ToDecimal(dsSalesItemList.Tables[0].Rows[0]["productlink_price"]).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture);
                            litProdView6.Text = "<a href='" + strView + "'class='sublink' target='_blank'>View</a>";
                        }
                        else if (cntProduct == 6)
                        {
                            ...
                            lblProductId7.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_id"]);
                            lblProdTitle7.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_title"]);
                            // lblProdPrice7.Text = "$" + Convert.ToString(Math.Round(Convert.ToDouble(dsSalesItemList.Tables[0].Rows[6]["productlink_price"]), 2));
                            lblProdPrice7.Text = "$" + Convert.ToDecimal(dsSalesItemList.Tables[0].Rows[0]["productlink_price"]).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture);
                            litProdView7.Text = "<a href='" + strView + "'class='sublink' target='_blank'>View</a>";
                        }
                        else if (cntProduct == 7)
                        {
                            ...
                            lblProductId8.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_id"]);
                            lblProdTitle8.Text = Convert.ToString(dsSalesItemList.Tables[0].Rows[0]["product_title"]);
                            //lblProdPrice8.Text = "$" + Convert.ToString(Math.Round(Convert.ToDouble(dsSalesItemList.Tables[0].Rows[7]["productlink_price"]), 2));
                            lblProdPrice8.Text = "$" + Convert.ToDecimal(dsSalesItemList.Tables[0].Rows[0]["productlink_price"]).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture);
                            litProdView8.Text = "<a href='" + strView + "'class='sublink' target='_blank'>View</a>";
                        }
                    ...
                    for (cntProduct = 0; cntProduct < dsSalesItemList.Tables[0].Rows.Count; cntProduct++)
                    {
                        ...
                        else if (cntProduct == 6)
                        {
                            ...
                            else
                            {
                                ...
                                imgFeat7.ImageUrl = Thumbnail(strImgName);
                            }
                        ...
                        else if (cntProduct == 7)
                        {
                            ...
                            else
                            {
                                ...
                                imgFeat8.ImageUrl = Thumbnail(strImgName);
                            }
        ...
        public void getAllUsersEmailAddress()
        {
            ...
            //check if all the zipcode selected or just a single zipecode.
            if (Request.QueryString["zipcode"].ToString()=="Send to All")
            {
                dsGetAllUsersEmailAddress = dbListInfo.GetUsersEmailAddress(intUsersStatusId, intUsersNewsletter);
            }
            else
            {
                dsGetAllUsersEmailAddress = dbListInfo.GetUsersEmailAddress_zip(intUsersStatusId, intUsersNewsletter, Request.QueryString["zipcode"].ToString());
            }
            ...
            try
            {
                ...
                if (strAllUserEmails.Length - 1 > 0)
                {
                    for (int email = 0; email < strAllUserEmails.Length - 1; email++)
                    {
                        ...
                        string strHeader = "https://valetgrocery.com/images/newsletter_header.gif";
                        ...
                        string strImgProd = "https://valetgrocery.com/Product/";
