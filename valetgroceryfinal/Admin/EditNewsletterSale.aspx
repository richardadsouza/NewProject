<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="EditNewsletterSale.aspx.cs" Inherits="groceryguys.Admin.EditNewsletterSale" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText">
                                                    ...
                                                    <br />
                                                    <span class="formTextSmall">(mm/dd/yyyy)</span>
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText" valign="top">Header Message:
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="left" class="formText">Sale Items:<br />
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText">Items1:
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText">Items2:
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText">Items3:
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText">Items4:
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText">Items5:
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText">Items6:
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText">Items7:
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText">Items8:
                                                </td>
                                                <td width="56%" height="40">
                                            ...
                                            <tr>
                                                <td width="44%" align="right" class="formText" valign="top">Footer Message:
                                                </td>
                                                <td width="56%" height="40">
