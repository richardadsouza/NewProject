<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserOrderDetailsInfo.aspx.cs"
    Inherits="groceryguys.Admin.UserOrderdetailsInfo" %>
            ...
            <table border="0" cellpadding="3" cellspacing="0" class="table-border ">
                <tr>
                    <td style="padding-left: 550px" colspan="2">
                        <a href='UserOrderdetailsPrint.aspx?orderId=<%=Request.QueryString["orderId"]%>&userId=<%=Request.QueryString["userId"]%>' target="_blank">
