<%@ Page Title="Update Account" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true"
    CodeBehind="EditTransactions.aspx.cs" Inherits="groceryguys.Admin.EditTransactions" %>
                        ...
                        <tr>
                            <td height="30" class="formText">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td width="44%" align="right" class="formText">Date:
                                        </td>
                                    ...
                                    <tr>
                                        <td align="right" class="formText">Order #:<br />
                                            (if applicable)
                                        </td>
                                        <td height="40">
