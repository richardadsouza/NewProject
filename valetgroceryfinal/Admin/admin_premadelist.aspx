<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="admin_premadelist.aspx.cs" Inherits="groceryguys.Admin.admin_premadelist" %>
                ...
                <fieldset>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td height="40">
                                <asp:DropDownList ID="drpShelf" runat="server" CssClass="DropDownBox" AutoPostBack="true"
                                    OnSelectedIndexChanged="drpShelf_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" class="formText">Product:
                            </td>
                            <td height="40">
