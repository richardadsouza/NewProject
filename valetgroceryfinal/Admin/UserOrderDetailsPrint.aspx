<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserOrderDetailsPrint.aspx.cs"
    Inherits="groceryguys.Admin.UserOrderdetailsPrint" %>
...
<body style="background-image:none; background-color:white; font-size:14px;" onload="javascript:window.print()">
            ...
            <tr>
                <td colspan="2">
                  <asp:GridView ID="gridUserProductList" runat="server" AutoGenerateColumns="False" GridLines="None" 
                        PageSize="5" Width="100%" BorderWidth="0px" >
                        <Columns>
                        ...
                        <HeaderStyle CssClass="gridheading" ForeColor="white" BackColor="#2220BC" /> 
