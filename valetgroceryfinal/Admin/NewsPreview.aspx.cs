            ...
            try
            {
                ...
                if (strAllUserEmails.Length - 1 > 0)
                {
                    for (int email = 0; email < strAllUserEmails.Length - 1; email++)
                    {
                      ...
                      //  string strHeader = "https://www.groceryguys.com/images/newsletter_header.gif";
                        string strHeader = "http://74.54.22.52/$sitepreview/valetgrocery.com/images/newsletter_header.gif";
                       ...
                       // string strImgProd = "https://www.groceryguys.com/Product/";
                        string strImgProd = "http://74.54.22.52/$sitepreview/valetgrocery.com/Product/";
