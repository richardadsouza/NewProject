<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true"
    CodeBehind="admin_editoreder.aspx.cs" Inherits="groceryguys.Admin.admin_editoreder" %>
            ...
            <table border="0" cellpadding="3" cellspacing="0" class="table-border ">
                <tr>
                    <td style="padding-left: 550px" colspan="2">
                        <a href='UserOrderDeatilsPrint.aspx?orderId=<%=Request.QueryString["orderId"]%>&userId=<%=Request.QueryString["userId"]%>'
                            target="_blank">
                        ...
                        <table cellpadding="3" cellspacing="0" border="0">                           
                            ...
                            <tr>
                                ...
                                <td align="left" class="formTextSmall">
                                    ...
                                    &nbsp;
                                    <asp:TextBox runat="server" ID="lblZip"></asp:TextBox><br />
                ...
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gridUserProductList" runat="server" AutoGenerateColumns="False"
                            Width="600" CssClass="gridBorder" CellPadding="0" CellSpacing="0" OnRowCommand="gridUserProductList_OnRowCommand">
                            <Columns>
