<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="index3.aspx.cs" ValidateRequest="false" Inherits="groceryguys.Admin.index3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="Logoutlink">Welcome <em class="username"><strong>
                <asp:Label ID="lblUserName" runat="server"></asp:Label></strong></em>, to the&nbsp;<asp:Label ID="lblCmpyNm" runat="server"></asp:Label>&nbsp;site manager. </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gridOrderList" runat="server" AutoGenerateColumns="False" Width="80%"
                            ...
                            <Columns>
                                ...
                                </asp:TemplateField>                                                                <asp:TemplateField HeaderText="First Name" SortExpression="users_fname">
                                    <ItemTemplate>
