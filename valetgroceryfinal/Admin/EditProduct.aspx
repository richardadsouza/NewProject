<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true"
    CodeBehind="EditProduct.aspx.cs" Inherits="groceryguys.Admin.EditProduct" %>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td align="right" valign="top">
                                            Upload Image:
                                              <br /><br />Or Enter SmallImage Name :
                                        </td>
                                        <td style="padding-left: 5px;">
                                            <asp:FileUpload ID="uploadImg" runat="server" />
                                            <asp:label ID="lblSmallImg"  runat="server" Visible="true"></asp:label><br /><br />
                                            <asp:TextBox ID="txtSmallImg" runat="server" CssClass="textBox" MaxLength="50"></asp:TextBox><br /><br />
                                            </td>                                            
                                    </tr>
                                     <tr>
                                        ...
                                        <td height="40" style="padding-left: 5px;">
                                            <asp:FileUpload ID="uploadLargeImg" runat="server" />
                                             <asp:label ID="lblLargeImag"  runat="server" Visible="true"></asp:label><br /><br />
                                             <asp:TextBox ID="txtLargeImag" runat="server" CssClass="textBox" MaxLength="50"></asp:TextBox><br /><br />
                                            </td>                                   
                                     </tr>
                                    <tr>
                                        <td align="right" valign="top" class="formText">
