<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true"
    CodeBehind="savelist.aspx.cs" Inherits="groceryguys.savelist" %>
    ...
    <asp:UpdatePanel ID="updatePnl1" runat="server">
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="padding-left: 10px;">
                <tr>
                    <td align="left" class="formHeading" colspan="2">Save Your List
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <asp:Panel ID="pnlSave" runat="server">
                            <table class="formTextUser">
                                <tr>
                                    <td colspan="2">You can save your shopping list for next time:
                                    </td>
                                </tr>
                                <tr>
                                    <td height="10px" colspan="2"></td>
                                ...
                                <tr>
                                    <td valign="top">
                                        <table class="formTextUser">
                                            <tr>
                                                <td colspan="2" align="center" class="formTextUser">Field with a <span class="star1">*</span> are required
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                <td width="50" class="formTextSmall1" align="center" valign="top">
                                                                                    <asp:Label ID="lblQty" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Qty") %>'></asp:Label></td>
                                                                                <td width="150" class="formTextSmall1" valign="top" align="left">
                                                                                    <asp:Label ID="lblProductNm" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ProdNm") %>'></asp:Label></td>
                                                                                <td class="formTextSmall1" valign="top" align="center">
                                                                                    <asp:Label ID="lblPrice" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Price") %>'></asp:Label></td>
                                                                            </tr>
                                                                        </table>
                                                                    </ItemTemplate>
                                                                </asp:DataList></td>
                        ...
                        <asp:Panel ID="pnlSuccuss" runat="server">
                            <table>
                                <tr>
                                    <td class="formTextUser">Your list has been successfully saved!
                                    </td>
                                </tr>
                                <tr>
                                    <td height="10px"></td>
