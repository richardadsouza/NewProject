<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="deposit.aspx.cs" Inherits="groceryguys.deposit" %>
        ...
        <table width="100%">
            <tr>
                <td align="left" class="formHeading">
                    <strong>
                        <asp:Label ID="lblCompanyNameTitle" runat="server"></asp:Label>
                        &nbsp;Shopping 
                Funds</strong>
                </td>
            </tr>
            ...
            <tr>
                <td class="formTextUser">When you are ready, choose the amount you wish to deposit <strong>($<asp:Label ID="lblMinAmt" runat="server"></asp:Label>&nbsp;minimum)</strong> and fill out the form below.
                </td>
            </tr>
            <tr>
                <td height="10px"></td>
                ...
                <td align="left" class="formTextUser">
                    <table cellpadding="3" cellspacing="0" border="0" width="100%">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <asp:TextBox ID="txtDepositAmt" Width="200px" runat="server" CssClass="textbox1" MaxLength="50"></asp:TextBox>
                        ...
                        <tr valign="top">
                            ...
                            <td valign="top">
                                <asp:TextBox ID="txtPerMsg" Width="200px" runat="server" CssClass="textMultiline" MaxLength="2000" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td height="10px"></td>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <asp:TextBox ID="txtFName" Width="200px" runat="server" CssClass="textbox1" MaxLength="50"></asp:TextBox>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <asp:TextBox ID="txtZip" Width="200px" runat="server" CssClass="textbox1" MaxLength="5"></asp:TextBox>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <asp:TextBox ID="txtPhone" Width="200px" runat="server" CssClass="textbox1" MaxLength="12"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan="2" style="width:100%;">
                                <asp:Panel ID="pnlAuthorize" runat="server" Visible="false" Width="100%">
                                    <table width="100%">
                                        <tr>
                                            <td height="5px"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="formHeadingText" align="center" style="width:100%;">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPayCCNm" Width="200px" runat="server" CssClass="textbox1" MaxLength="16"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="Rfvccc" runat="server" Text="*" ControlToValidate="txtPayCCNm"
                                            ...
                                            <td>
                                                <asp:Panel ID="pnlPayPal" runat="server" Visible="false">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox Width="200px" ID="txtPayExp" runat="server" MaxLength="6" CssClass="textbox1"></asp:TextBox>
                                                            </td>
